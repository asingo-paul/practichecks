...
export default function HirerViewInternshipPage() {
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Internship Details</h1>
                  <p className="text-gray-600">Manage your internship posting</p>
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-gray-900">
                        {Math.floor((Date.now() - new Date(internship.postedDate).getTime()) / (1000 * 60 * 60 * 24))}
                      </span>
                    </div>
                  </div>
                </div>
